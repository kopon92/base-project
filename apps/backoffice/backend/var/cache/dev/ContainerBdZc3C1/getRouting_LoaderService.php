...
include_once \dirname(__DIR__, 7).'/vendor/symfony/config/Loader/LoaderResolverInterface.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/config/Loader/LoaderResolver.php';
...
include_once \dirname(__DIR__, 7).'/vendor/symfony/routing/Loader/AnnotationClassLoader.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/framework-bundle/Routing/AnnotatedRouteControllerLoader.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/routing/Loader/AnnotationFileLoader.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/routing/Loader/AnnotationDirectoryLoader.php';
...
$a->addLoader(new \Symfony\Component\Routing\Loader\ContainerLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    'kernel' => 'App\\Backoffice\\Backend\\BackofficeBackendKernel',
])));
$a->addLoader($c);
