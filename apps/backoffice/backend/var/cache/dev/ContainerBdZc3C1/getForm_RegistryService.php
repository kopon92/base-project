...
include_once \dirname(__DIR__, 7).'/vendor/symfony/form/FormRegistryInterface.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/form/FormRegistry.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/form/FormExtensionInterface.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/form/Extension/DependencyInjection/DependencyInjectionExtension.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/form/ResolvedFormTypeFactoryInterface.php';
include_once \dirname(__DIR__, 7).'/vendor/symfony/form/ResolvedFormTypeFactory.php';
